...
class BiddingController extends Controller
{
    public function postBid(Request $request)
    {
        ...
        $highestBid = DB::select("SELECT userID, auctionID, latestBid From bidding where latestBid = (Select MAX(latestBid) from bidding b ) AND auctionID = $auctionID LIMIT 1");
